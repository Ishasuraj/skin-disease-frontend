...
import { Sparkles, Brain, Camera, BookOpen, Layers, Globe, Shield } from 'lucide-react';

const featureKeys = [
  { icon: Brain, key: 'aiPrediction', color: 'bg-blue-50 dark:bg-blue-900/20 border-blue-100 dark:border-blue-800', iconBg: 'bg-blue-100 dark:bg-blue-900/40', iconColor: 'text-blue-600 dark:text-blue-400' },
  ...
  { icon: Shield, key: 'secure', color: 'bg-rose-50 dark:bg-rose-900/20 border-rose-100 dark:border-rose-800', iconBg: 'bg-rose-100 dark:bg-rose-900/40', iconColor: 'text-rose-600 dark:text-rose-400' },
];
