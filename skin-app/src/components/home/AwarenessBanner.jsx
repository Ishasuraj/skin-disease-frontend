    ...
    <section id="awareness" className="py-20 bg-white dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-br from-blue-600 to-cyan-500 dark:from-blue-800 dark:to-cyan-700 rounded-3xl p-10 text-center text-white transition-colors duration-300">
          <Stethoscope className="w-12 h-12 text-white/90 mx-auto mb-4" />
          ...
          <button
            ...
            className="inline-flex items-center bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 font-bold px-8 py-3 rounded-xl hover:bg-blue-50 dark:hover:bg-slate-700 transition-all shadow-lg mx-auto"
          >
