...
const ImageUpload = ({ images, setImages, selectedImageId, setSelectedImageId }) => {
  ...
  if (result.error === 'not_skin') {
    throw new Error('⚠️ This does not appear to be a skin image. Please upload a clear close-up photo of affected skin.');
  }
...
<div className="space-y-3">
  ...
  <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl p-4 flex gap-3">
    ...
    <div className="text-xs text-amber-800 dark:text-amber-300 space-y-1.5">
      ...
      <ul className="list-disc list-inside space-y-1 pl-1">
        <li>Only upload skin images for accurate results</li>
        <li>Do not upload clothes, objects or random images</li>
        <li>Avoid full body or blurry photos</li>
      </ul>
    </div>
  </div>
</div>
